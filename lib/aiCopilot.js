...
export async function createCopilotInsight({ asset, analysis, profile }) {
  const fallback = buildFallbackInsight({ asset, analysis, profile });
...
function buildFallbackInsight({ asset, analysis, profile }) {
  ...
  return {
    ...
    summary: `${profileLabel} guardrails place this asset at opportunity ${analysis.opportunityScore}/100 and risk ${analysis.riskScore}/100. Treat this as educational context, not a trading instruction.`,
    focusPoints: [
